(function(){
  ...
  const attachmentLink = row => {
    ...
    return '<a class="attachment-link" href="'+esc(url)+'" target="_blank" rel="noopener noreferrer" data-attachment-name="'+esc(name)+'" data-attachment-path="'+esc(path)+'">📎 '+esc(name || 'Otwórz załącznik')+'</a>';
  };
